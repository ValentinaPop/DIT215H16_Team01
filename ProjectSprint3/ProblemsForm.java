...
public class ProblemsForm extends JFrame {
	...
	public ProblemsForm() {
		...
		textField_Email.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(128, 0, 0), null, null, null));
		...
		textArea_Problems.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(128, 0, 0), null, null, null));
		textArea_Problems.setWrapStyleWord(true);
		textArea_Problems.setLineWrap(true);
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnSend, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
