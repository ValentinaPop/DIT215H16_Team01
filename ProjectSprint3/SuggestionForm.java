...
public class SuggestionForm extends JFrame {
	...
	public SuggestionForm() {
		...
		textArea_Suggestions.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(128, 0, 0), null, null, null));
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnSend, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE)))
		);
