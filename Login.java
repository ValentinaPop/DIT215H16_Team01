...
public class Login extends JFrame {
	...
	public Login() {
		...
		JLabel lblForgotPassword = new JLabel("<HTML><U>Forgot your password?</U></HTML>"); // NOT WORKING
...
// Go to a new JinternalFrame where asks for an email to send the password connected to it.
		...
		lblForgotPassword.setForeground(Color.BLUE);
			...
			JLabel UserIcon = new JLabel("");
			UserIcon.setIcon(new ImageIcon("/Users/LFigueroa/Desktop/User1.png"));
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									...
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(textField_Email, GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE))))
							.addGroup(gl_contentPane.createSequentialGroup()
								.addPreferredGap(ComponentPlacement.RELATED, 229, GroupLayout.PREFERRED_SIZE)
								.addComponent(btnJoinUs)))
						.addGap(22))
			);
			gl_contentPane.setVerticalGroup(
